...
from pyos.client import _safe_quote

from pyos import fakes

DUMMY_URL = "http://example.com"
ID_CLS = pyos.settings.get("identity_class") or pyos.rax_identity.RaxIdentity
...
class ClientTest(unittest.TestCase):
    ...
    @patch("pyos.exceptions.from_response")
    @patch("pyos.http.request")
