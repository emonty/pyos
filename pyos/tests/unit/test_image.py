...
import pyos.image
from pyos.image import assure_image
from pyos.image import ImageMember
from pyos.image import ImageTasksManager
from pyos.image import JSONSchemaManager
...
class ImageTest(unittest.TestCase):
    ...
    @patch("pyos.manager.BaseManager.create")
