...
import pyos
import pyos.object_storage
from pyos.object_storage import ACCOUNT_META_PREFIX
from pyos.object_storage import assure_container
from pyos.object_storage import BulkDeleter
from pyos.object_storage import Container
from pyos.object_storage import CONTAINER_META_PREFIX
from pyos.object_storage import Fault_cls
from pyos.object_storage import FAULT
from pyos.object_storage import FolderUploader
from pyos.object_storage import get_file_size
from pyos.object_storage import _handle_container_not_found
from pyos.object_storage import _handle_object_not_found
from pyos.object_storage import OBJECT_META_PREFIX
from pyos.object_storage import _massage_metakeys
from pyos.object_storage import StorageClient
from pyos.object_storage import StorageObject
from pyos.object_storage import StorageObjectIterator
from pyos.object_storage import _validate_file_or_path
from pyos.object_storage import _valid_upload_key
import pyos.exceptions as exc
import pyos.utils as utils

import pyos.fakes as fakes
...
class ObjectStorageTest(unittest.TestCase):
    ...
    @patch('pyos.object_storage.StorageObjectManager',
    ...
    @patch("pyos.object_storage.assure_container")
    ...
    @patch("pyos.object_storage.StorageObjectIterator", new=fakes.FakeIterator)
    ...
    def test_sobj_mgr_upload_multiple(self):
        obj = self.obj
        mgr = obj.manager
        sav = pyos.object_storage.MAX_FILE_SIZE
        pyos.object_storage.MAX_FILE_SIZE = 42
        obj_name = utils.random_unicode()
        content_type = utils.random_unicode()
        content_encoding = utils.random_unicode()
        content_length = None
        ...
        pyos.object_storage.MAX_FILE_SIZE = sav
    ...
    @patch("pyos.manager.BaseManager.delete")
    ...
    @patch("pyos.client.BaseClient.get")
    ...
    @patch("pyos.object_storage.FolderUploader.start")
    ...
    @patch("pyos.object_storage.BulkDeleter.start")
