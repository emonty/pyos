...
from pyos.clouddns import assure_domain
...
from pyos.clouddns import ResultsIterator
from pyos.clouddns import DomainResultsIterator
from pyos.clouddns import SubdomainResultsIterator
from pyos.clouddns import RecordResultsIterator
...
#        uri = "/domains/%s/subdomains" % utils.get_id(dom)
    ...
    def test_get_ptr_details_lb(self):
        ...
        sav = pyos._get_service_endpoint
        pyos._get_service_endpoint = Mock(return_value=example_uri)
        ...
        pyos._get_service_endpoint = sav
    ...
    # method_get.
    @patch.object(pyos.client.BaseClient, "method_get",
